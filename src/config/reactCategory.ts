...
export const reactContainers: CategoryType = {
	FormItemInput: {
		components: {
			FormItemInput: {
				props: [
					{ label: 'label', name: 'name', onChange: () => { } }
				],
			},
		},
	},
	Modal: {
		components: {
			Modal: {
				props: [
					{
						style: { display: 'none' }, visible: false, title: '',
						destroyOnClose: false, onCancel: () => { }, onOk: () => { }, modalRef: ''
					}
				],
			},
		},
	...
	FormItemButton: {
		components: {
			FormItemButton: {
				props: [
					{ style: { minHeight: '60px', width: '300px', backgroundColor: '#fff' } }
				],
			},
		},
	},
	...
	Row: {
		components: {
			Row: {
				props: [
					{ style: { minHeight: '60px', backgroundColor: '#fff' } }
				],
			},
		},
	},
